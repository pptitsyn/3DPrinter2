    ...
    public class GCodeAnalyzer
    {
        ...
        public void fireChanged()
        {
            if (eventChange != null)
            {
                try
                {
                    GCodeVisual.Invoke_Method(eventChange);
...
//**                    Main.main.Invoke(eventChange);
        ...
        public void start(bool fire)
        {
            ...
            printerWidth = SettingsProvider.Instance.SelectedPrinterSettings.PrintAreaWidth;
            printerDepth = SettingsProvider.Instance.SelectedPrinterSettings.PrintAreaDepth;
            printerHeight = SettingsProvider.Instance.SelectedPrinterSettings.PrintAreaHeight;
            
            
            if (!privateAnalyzer)
                GCodeVisual.ResetQuality();
            if (fire)
                fireChanged();
        }
        ...
        public void Analyze(GCode code)
        {
            ...
            if (code.hostCommand)
            {
                ...
                else if (cmd.Equals("@isathome"))
                {
                    ...
                    x = SettingsProvider.Instance.SelectedPrinterSettings.XHomePos;
                    y = SettingsProvider.Instance.SelectedPrinterSettings.YHomePos;
                    z = SettingsProvider.Instance.SelectedPrinterSettings.ZHomePos;
                    if (SettingsProvider.Instance.SelectedPrinterSettings.printerType != 3)
                        xOffset = yOffset = zOffset = 0;
                }
                return;
            }
            ...
            if (code.hasG)
            {
                switch (code.G)
                {
                    ...
                    case 1:
                        ...
                        if (x < SettingsProvider.Instance.SelectedPrinterSettings.XMin) { x = SettingsProvider.Instance.SelectedPrinterSettings.XMin; hasXHome = false; }
                        if (y < SettingsProvider.Instance.SelectedPrinterSettings.YMin) { y = SettingsProvider.Instance.SelectedPrinterSettings.YMin; hasYHome = false; }
                        if (z < 0 && SettingsProvider.Instance.SelectedPrinterSettings.printerType != 3) { z = 0; hasZHome = false; }
                        if (x > SettingsProvider.Instance.SelectedPrinterSettings.XMax) { hasXHome = false; }
                        if (y > SettingsProvider.Instance.SelectedPrinterSettings.YMax) { hasYHome = false; }
...
***/
                        ...
                        if (eventPosChanged != null)
                            if (privateAnalyzer)
                                ...
                                GCodeVisual.Invoke_Method(eventPosChanged, code, x, y, z);
                    ...
                    case 161:
                        {
                            ...
                            if (code.hasX || homeAll) { xOffset = 0; x = SettingsProvider.Instance.SelectedPrinterSettings.XHomePos; hasXHome = true; }
                            if (code.hasY || homeAll) { yOffset = 0; y = SettingsProvider.Instance.SelectedPrinterSettings.YHomePos; hasYHome = true; }
                            if (code.hasZ || homeAll) { zOffset = 0; z = SettingsProvider.Instance.SelectedPrinterSettings.ZHomePos; hasZHome = true; }
...
//**                                    Main.main.Invoke(eventPosChanged, code, x, y, z);
                    ...
                    case 162:
                        {
                            bool homeAll = !(code.hasX || code.hasY || code.hasZ);
                            if (code.hasX || homeAll) { xOffset = 0; x = SettingsProvider.Instance.SelectedPrinterSettings.XMax; hasXHome = true; }
                            if (code.hasY || homeAll) { yOffset = 0; y = SettingsProvider.Instance.SelectedPrinterSettings.YMax; hasYHome = true; }
                            if (code.hasZ || homeAll) { zOffset = 0; z = SettingsProvider.Instance.SelectedPrinterSettings.PrintAreaHeight; hasZHome = true; }
                            if (eventPosChanged != null)
                                if (privateAnalyzer)
                                    eventPosChanged(code, x, y, z);
                                else
...
***/
                ...
                if (code != null)
                {
                    if (privateAnalyzer)
                        ...
                        GCodeVisual.Invoke_Method(eventPosChanged, code, center_axis0 + r_axis0, center_axis1 + r_axis1, z);
        ...
        public void analyzeShort(GCodeShort code)
        {
            ...
            switch (code.compressedCommand)
            {
                case 1:
                    ...
                    lastZ = z;
                    activeExtruder.lastE = activeExtruder.e;
                    filamentLength = Math.Max(filamentLength, activeExtruder.e);
                    break;
                case 2:
                case 3:
                    {
                ...
                case 12: // Host command
                    {
                        ...
                        {
                            hasXHome = hasYHome = hasZHome = true;
                            x = xOffset = SettingsProvider.Instance.SelectedPrinterSettings.XHomePos;
                            y = yOffset = SettingsProvider.Instance.SelectedPrinterSettings.YHomePos;
                            z = zOffset = SettingsProvider.Instance.SelectedPrinterSettings.ZHomePos;
                        }
                    }
                    break;
                case 9:
