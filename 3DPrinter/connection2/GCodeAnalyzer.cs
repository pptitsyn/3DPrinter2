...
using _3DPrinter.view.sliceVisual; // PTITSYN
            ...
            if (code.hasG)
            {
                switch (code.G)
                {
                    ...
                    case 1:
                        ...
                        if (y < SettingsProvider.Instance.SelectedPrinterSettings.YMin/*Main.printerSettings.YMin*/) { y = SettingsProvider.Instance.SelectedPrinterSettings.YMin/*Main.printerSettings.YMin*/; hasYHome = false; }
                    ...
                    case 3:
                        {
                          ...
                          center of arc when h_x2_div_d is positive ->  x <----- | -----> x <- center of arc when h_x2_div_d is negative
                            ...
                            activeExtruder.lastE = activeExtruder.e;
                            if (x < SettingsProvider.Instance.SelectedPrinterSettings.XMin) { x = SettingsProvider.Instance.SelectedPrinterSettings.XMin; hasXHome = false; }
                            if (y < SettingsProvider.Instance.SelectedPrinterSettings.YMin/*Main.printerSettings.YMin*/) { y = SettingsProvider.Instance.SelectedPrinterSettings.YMin; hasYHome = false; }
                    ...
                    case 162:
                        {
                            ...
                            if (code.hasZ || homeAll) { zOffset = 0; z = SettingsProvider.Instance.SelectedPrinterSettings.PrintAreaHeight/*Main.printerSettings.PrintAreaHeight*/; hasZHome = true; }
                            if (eventPosChanged != null)
                                if (privateAnalyzer)
                                    eventPosChanged(code, x, y, z);
                                else
