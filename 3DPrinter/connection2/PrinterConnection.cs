...
using _3DPrinter.gcode; // PTTISYN
      ...
      //  long lastReceived = 0;
       ...
       /* private void StoreHistory(GCode gcode)
        ...
        public void open()
        {
            ...
            // PPTITSYN Main.printerSettings.Hide();
            connector.Connect();
        }
        ...
        public void analyzeResponse(string res,ref int level)
        {
            ...
            {
                level = 2;
                // PTITSYN RepetierHost.view.SoundConfig.PlayError(false);
            }
...
///});
        ...
        public void doDispose()
        {
            ...
            if (analyzer.hasZHome && analyzer.z + analyzer.zOffset < disposeZ && disposeZ > 0 && disposeZ <= SettingsProvider.Instance.SelectedPrinterSettings.PrintAreaHeight /*Main.printerSettings.PrintAreaHeight*/)
            {
