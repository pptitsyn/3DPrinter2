...
namespace _3DPrinter.model.geom
{
    ...
    public class Submesh
    {
        ...
        int ConvertColorIndex(int idx)
        {
            ...
            switch (idx)
            {
                case MESHCOLOR_FRONTBACK:
                    if (selected)
                        return ColorToRgba32(SettingsProvider.Instance.ThreeDSettings.selectedFaces);
                    return ColorToRgba32(defaultColor);
                case MESHCOLOR_BACK:
                    return ColorToRgba32(SettingsProvider.Instance.ThreeDSettings.insideFaces);
                case MESHCOLOR_ERRORFACE:
                    return ColorToRgba32(SettingsProvider.Instance.ThreeDSettings.errorModel);
                case MESHCOLOR_ERROREDGE:
                    return ColorToRgba32(SettingsProvider.Instance.ThreeDSettings.errorModelEdge);
                case MESHCOLOR_OUTSIDE:
                    return ColorToRgba32(SettingsProvider.Instance.ThreeDSettings.outsidePrintbed);
                case MESHCOLOR_EDGE_LOOP:
                    return ColorToRgba32(SettingsProvider.Instance.ThreeDSettings.edges);
                case MESHCOLOR_CUT_EDGE:
                    return ColorToRgba32(SettingsProvider.Instance.ThreeDSettings.cutFaces);
        ...
        public void Draw(int method,Vector3 edgetrans,bool forceFaces=false)
        {
            ...
            GL.Material(MaterialFace.Back, MaterialParameter.AmbientAndDiffuse, convertColor(SettingsProvider.Instance.ThreeDSettings.insideFaces));
            ...
            if (method == 2)
            {
                ...
                GL.BindBuffer(BufferTarget.ElementArrayBuffer, glBuffer[3]);
                if (SettingsProvider.Instance.ThreeDSettings.ShowFaces || forceFaces)
            ...
            else if (method == 1)
            {
                ...
                GL.Material(MaterialFace.FrontAndBack, MaterialParameter.AmbientAndDiffuse, convertColor(SettingsProvider.Instance.ThreeDSettings.errorModel));
                GL.LightModel(LightModelParameter.LightModelTwoSide, 0);
