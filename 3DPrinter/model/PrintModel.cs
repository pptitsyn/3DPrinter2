...
/*
        ...
        */
        ...
        public void UpdateMatrix()
        {
            ...
            scale = Matrix4.Scale(Scale.X!=0 ? Scale.X : 1, Scale.Y != 0 ? Scale.Y : 1, Scale.Z != 0 ? Scale.Z : 1);
        ...
        public void UpdateMatrixReverse(bool breverse)
        {
            Matrix4 scale;
            ...
            if (breverse)
            scale = Matrix4.Scale(Scale.X != 0 ? Scale.X * (-1) : 1 * (-1), Scale.Y != 0 ? Scale.Y : 1, Scale.Z != 0 ? Scale.Z : 1);
            else
                scale = Matrix4.Scale(Scale.X != 0 ? Scale.X  : 1, Scale.Y != 0 ? Scale.Y : 1, Scale.Z != 0 ? Scale.Z : 1);
