...
namespace _3DPrinter.model
{
    public class PrinterModel : INotifyPropertyChanged
    {
        ...
        public PrinterModel()
        {
            key = SettingsProvider.Instance.Printer_Settings.GetCurrentPrinterKey(); //.currentPrinterKey;
           // SettingsProvider.Instance.Printer_Settings.eventPrinterChanged += PrinterChanged;
