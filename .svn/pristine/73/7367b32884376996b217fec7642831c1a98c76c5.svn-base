...
namespace _3DPrinter.connection
{
    ...
    public class EEPROMMarlinStorage
    {
        ...
        {
            conn.injectManualCommand("M500");
        }
        public void retriev_factory_settings()
        {
            hasPID = false;
            conn.injectManualCommand("M502");
        }
        public void Add(string line)
        {
            ...
            Application.Current.MainWindow.Dispatcher.Invoke(eventAdded, this);
        }
        public void Update()
        {
            hasPID = false;
            conn.injectManualCommand("M503");
        }
    }
}
