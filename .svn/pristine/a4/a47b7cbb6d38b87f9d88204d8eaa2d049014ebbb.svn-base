...
/*
        ...
        public static string WindowPosToString(Window f, bool state)
        {
            Rectangle rest = f.DesktopBounds;
            return rest.X.ToString() + "|" +
                rest.Y.ToString() + (state ? f.WindowState.ToString() : "");
        }
        public static string WindowPosSizeToString(Window f, bool state)
        {
            Rectangle rest = f.DesktopBounds;
        ...
        public static void StringToWindowPos(Window f, string pos, int screenId)
        {
        ...
        public static void StoreWindowPos(string name, Window f, bool storeSize, bool storeState)
        {
        ...
        public static void RestoreWindowPos(string name, Window f)
        {
