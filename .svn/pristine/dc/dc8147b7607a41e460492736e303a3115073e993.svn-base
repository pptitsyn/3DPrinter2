...
namespace _3DPrinter.model
{
    class Coordinate
    {
        ...
        private void DrawArrow()
        {
            ...
            submesh[2].Draw(SettingsProvider.Instance.ThreeDSettings.drawMethod, ctrl.cam.EdgeTranslation(),true);
            GL.PopMatrix();

            // Draw Y coordinated
            GL.PushMatrix();
            GL.Rotate(90.0d, 0.0d, 1.0d, 0.0d);
            submesh[1].Draw(SettingsProvider.Instance.ThreeDSettings.drawMethod, ctrl.cam.EdgeTranslation(),true);
            GL.PopMatrix();
            ...
            submesh[0].Draw(SettingsProvider.Instance.ThreeDSettings.drawMethod, ctrl.cam.EdgeTranslation(),true);
            GL.PopMatrix();
