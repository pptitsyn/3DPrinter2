...
namespace _3DPrinter.view.notification
{
    ...
    {
        public static readonly SolidColorBrush Success = "#1f1f1f".ToSolidColorBrush();
        public static readonly SolidColorBrush Info = "#1f1f1f".ToSolidColorBrush();
        public static readonly SolidColorBrush Error = "#1f1f1f".ToSolidColorBrush();
        public static readonly SolidColorBrush Warning = "#1f1f1f".ToSolidColorBrush();
    }
